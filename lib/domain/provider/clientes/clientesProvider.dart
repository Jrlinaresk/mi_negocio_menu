...
final clientesProvider = FutureProvider<List<Categoria>>((ref) async {
...
class CategoriaNotifier extends Notifier<List<Categoria>> {
  final AsyncValue<List<Categoria>> clientes;
  final String baseUrl;
  final String authToken;

  CategoriaNotifier(
      {required this.clientes, required this.baseUrl, required this.authToken})
      : super();

...
class LocationNotifierLite extends StateNotifier<List<Ubicacion>> {
  ...
  void addInicialUbicacion(Ubicacion ubicacion) {
    ubicacion = state.first;
  }

  // Método para actualizar la lista con nuevas ubicaciones
  void updateUbicacionesLite(List<Ubicacion> ubicaciones) {
    state = ubicaciones;
  }

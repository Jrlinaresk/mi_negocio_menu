...
import 'package:minegociomenu/presentation/Screens/products/presentation/widgets/product_widget.dart';
...
class NegocioDetailScreen extends ConsumerStatefulWidget {
  const NegocioDetailScreen({super.key});

  @override
  _NegocioDetailScreenState createState() => _NegocioDetailScreenState();
}
...
class _NegocioDetailScreenState extends ConsumerState<NegocioDetailScreen> {
  ...
  Widget build(BuildContext context) {
    final Negociotlastview = ref.watch(lastView);
    nlist = ref.watch(NegocioStateNotifierProvider);
    final fnlist = ref.watch(filteredNegociosProvider);
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(negocioAsync.nombre),
      ),
      body: Stack(
        children: [
...
/*     setState(() {
      ref
          .read(NegocioStateNotifierProvider.notifier)
          .toggleNegocioFavorito(index, !negocio.favorito);

      ref
          .read(NegocioFavoritoStateNotifierProvider.notifier)
          .toggleNegocioFavorito(index, !negocio.favorito);
    }); */
  }
  ...
  _launchWhatsapp(BuildContext context, String telefono) async {
    ...
    var mensaje = "Hola me interesa su negocio";
    var whatsappAndroid =
